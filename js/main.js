;(function () {
	...
	var offcanvasMenu = function() {
		...
		// Event handler for internal links in the offcanvas menu
	...
	var burgerMenu = function() {
		// Prevent default behavior and toggle offcanvas class on button click
...
$(document).ready(function() {
	$(window).scroll(function() {
		...
		var headerEndScroll = 700; // Adjust this value as needed

		if (scrollPosition > headerEndScroll) {
	...
	// Toggle offcanvas menu on click
